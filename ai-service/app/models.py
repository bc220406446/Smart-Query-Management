...
class Query(Base):
    ...
    id: Mapped[str] = mapped_column(String(32), primary_key=True, default=new_id)
    ticket_number: Mapped[str] = mapped_column(String(32), unique=True, default=new_id)
    ...
    ai_classification: Mapped[Optional[Any]] = mapped_column(JSON)
...
class AuditLog(Base):
    ...
    entity_id: Mapped[Optional[str]] = mapped_column(String(32), index=True)
